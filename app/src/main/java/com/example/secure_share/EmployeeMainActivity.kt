...
class EmployeeMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main) // Set Employee layout
        ...
        sendFileButton.setOnClickListener {
            val intent = Intent(this, FileUploadActivity::class.java) // Use the correct activity name
        ...
        logoutButton.setOnClickListener {
            ...
            startActivity(intent)
            finish() // Close the EmployeeMainActivity
        }
    }
}
